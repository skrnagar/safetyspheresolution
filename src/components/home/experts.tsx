...
export function Experts() {
  return (
    <section id="experts" className="bg-slate-50 py-20 dark:bg-[#09182f] md:py-24">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {experts.map((expert, i) => (
            <AnimateIn key={expert.role} delay={i * 0.05}>
              <article className="h-full border border-slate-200 bg-white p-6 dark:border-white/10 dark:bg-white/5">
